		...
		<table class="table table-centered">
			...
			<tfoot>
				...
				<tr>
					...
					<td colspan="7"><small>9,8% van de winst, met in 2015 een maximum van € 8.631</small></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="7"><small>5,5%, winst uit onderneming - zelfstandigenaftrek - startersaftrek - mkb winstvrijstelling = belastbare winst</small></td>
				</tr>
				<tr>
					<td colspan="2"><small>Algemene heffingskorting</small></td>
					<td colspan="7"><small>€2242, tot een bedrag van €19.992</small></td>
				</tr>
				<tr>
					<td colspan="2"><small>Arbeidskorting</small></td>
					<td colspan="7"><small>1,793% x arbeidsinkomen, tot een bedrag van € 9.147 ( = winst voor de aftrekposten)</small></td>
				</tr>
			</tfoot>
			<tbody>
				<tr>
					...
					<td>
						<?php echo '€'.number_format( ($belastbarewinst*0.055), 2, ',' , '.' ); ?>
					</td>
					<td>
						<?php
					...
					<td><?php echo '€'.number_format( ($arbeidsinkomen*0.01793), 2, ',' , '.' ); ?></td>
				</tr>
			</tbody>
		</table>
	</div>
