		...
		<table class="table table-centered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php
							if($belastbarewinst <= 20142){
								$tax_income = $belastbarewinst*0.3655;
							}
							else if($belastbarewinst <= 33994){
								$tax_income = (($belastbarewinst-20142)*0.4085) + (20142*0.3655);
							}
							else if($belastbarewinst <= 68507){
								$tax_income = (($belastbarewinst-20142)*0.4085) + (20142*0.3655);
							}else{
								$tax_income = (($belastbarewinst-68507)*0.5195) + (48365*0.4085) + (20142*0.3655);
							}
				...
				<tr>
					<td>AF:
						<?php
							$heffingskorting = 	($tax_income > 68507) ? 0 :
												($tax_income > 20142) ? -(2265-(0.04683*($tax_income-20142))) :
												-2265;
						...
						<?php
							if($tax_income + $heffingskorting > 0){
								if($marge > 122957){
									...
									$arbeidskorting = -(3249 - (0.036*($marge-32705)));
								}
								else{
									$arbeidskorting = -3249;
								}
